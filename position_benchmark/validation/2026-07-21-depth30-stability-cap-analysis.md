...
`repeated_forfeit_only` is the leading fixed redesign. Its MAE is lower than the actual
...
3 configurations receive a different
...
`openai`. Excluding that lab changes the
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `current_move_cap` | 227.3 | 322.2 | +34.3 | 214.5 | 0.881 | 0.901 | 0.864 |
| `deduplicated_move_exposure_cap` | 236.2 | 325.7 | +49.9 | 231.7 | 0.000 | 0.000 | 0.000 |
| `trajectory_hazard_cap` | 235.7 | 325.9 | +49.1 | 230.9 | 0.642 | 0.662 | 0.648 |
| `two_affected_trajectory_gate` | 230.3 | 323.5 | +44.0 | 215.7 | 0.647 | 0.654 | 0.997 |
| `repeated_forfeit_only` | 207.2 | 265.6 | +107.1 | 171.0 | 0.723 | 0.654 | 1.000 |
| `no_hard_cap` | 215.0 | 277.4 | +114.8 | 176.9 | 0.655 | 0.655 | 0.992 |
### No-position-seed game ratings

| Candidate | MAE | RMSE | Bias | IVW MAE | Family bootstrap P(improves) | Lab bootstrap P(improves) | RD simulation P(improves) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `current_move_cap` | 282.6 | 376.5 | +3.9 | 220.6 | 0.338 | 0.349 | 0.196 |
| `deduplicated_move_exposure_cap` | 278.8 | 371.4 | +19.5 | 235.6 | 0.000 | 0.000 | 0.000 |
| `trajectory_hazard_cap` | 278.3 | 371.6 | +18.7 | 234.9 | 0.643 | 0.653 | 0.704 |
| `two_affected_trajectory_gate` | 272.9 | 369.5 | +13.6 | 219.5 | 0.641 | 0.660 | 0.995 |
| `repeated_forfeit_only` | 249.3 | 319.6 | +76.7 | 175.4 | 0.724 | 0.656 | 1.000 |
| `no_hard_cap` | 257.1 | 329.6 | +84.5 | 181.0 | 0.657 | 0.650 | 0.994 |

All bootstrap and uncertainty probabilities compare the candidate against the
actual production reference, `deduplicated_move_exposure_cap`. Candidates are
