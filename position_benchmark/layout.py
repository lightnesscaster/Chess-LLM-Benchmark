...
PROTOCOL_SEQUENCE_RESULTS_PATH = RESULTS_DIR / "protocol_sequence.json"
LEGALITY_STRESS_RESULTS_PATH = RESULTS_DIR / "legality_stress.json"
FAILURE_TRANSFER_RESULTS_PATH = RESULTS_DIR / "failure_transfer_screen.json"
...
FAILURE_TRANSFER_MATRIX_PATH = CANDIDATES_DIR / "failure_transfer_screen_v1" / "matrix.json"
FAILURE_TRANSFER_SHORTLIST_PATH = CANDIDATES_DIR / "failure_transfer_positive_3.json"
